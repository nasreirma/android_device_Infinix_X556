...
#TARGET_KERNEL_CONFIG := X556_defconfig
...
BOARD_MKBOOTIMG_ARGS := --kernel_offset $(BOARD_KERNEL_OFFSET) --ramdisk_offset $(BOARD_RAMDISK_OFFSET) --tags_offset $(BOARD_TAGS_OFFSET) --board Infinix_X556
...
# Graphics
BOARD_EGL_CFG := device/Infinix/X556/egl.cfg
...
# CWM
TARGET_RECOVERY_FSTAB := device/Infinix/X556/rootdir/root/recovery.fstab
TARGET_PREBUILT_RECOVERY_KERNEL := device/Infinix/X556/rootdir/kernel
